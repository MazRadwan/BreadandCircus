...
const server = http.createServer((req, res) => {
  ...
  if (req.url.startsWith("/assets") || req.url.startsWith("/styles") || req.url.startsWith("/scripts")) {
  ...
  if (req.url === "/jokes" && req.headers.accept && req.headers.accept.includes("application/json")) {
